...
## 1.5本章小结
本章主要介绍了课题的研究背景与意义，研究现状，研究内容等内容，最后介绍了本论文的组织结构设计。信息化管理模式顺应了信息化时代的变化，本人以现在主流的管理模式为前提，根据使用者的相关需求，设计出一款符合大众需求的网上房屋中介管理系统。
...
## 2.5本章小结
本章主要介绍了实现网上房屋中介管理系统的相关理论基础以及开发工具。本系统采用B/S模式，使用Java语言、AJAX技术、MySQL数据库等工具，设计系统功能、页面布局、后台数据等。开发本系统所使用的相关技术操作简单、容易掌握，Java语言具有跨平台性，可以支持在不同的浏览器使用本系统，MySQL数据库是开源的，减少了本系统的开发成本。
# 3需求分析
## 3.1功能需求分析
...
![C:\Users\Administrator\Desktop\img\wangshangfangwuzhongjie\房屋.jpg](/md/blog.003.jpeg)
图4.1 房屋实体属性图

（2）下图是房屋留言实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\wangshangfangwuzhongjie\房屋留言.jpg](/md/blog.004.jpeg)
图4.2 房屋留言实体属性图

（3）下图是用户实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\wangshangfangwuzhongjie\用户.jpg](/md/blog.003.jpeg)
图4.3 用户实体属性图

（4）下图是公告实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\wangshangfangwuzhongjie\公告.jpg](/md/blog.004.jpeg)
图4.4 公告实体属性图

（5）下图是房屋收藏实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\wangshangfangwuzhongjie\房屋收藏.jpg](/md/blog.004.jpeg)
图4.5 房屋收藏实体属性图

（6）下图是房屋订单实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\wangshangfangwuzhongjie\房屋订单.jpg](/md/blog.004.jpeg)
图4.6 房屋订单实体属性图
